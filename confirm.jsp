...
<body>
	<%System.out.println(request.getParameter("gameID")); %>
 	...
 	<form class="w3-container" action="../JSP/rent.jsp" id = "payment" method="post" >
						...
						<div class="row">
							...
							<input class="w3-input w3-border" type="hidden"  name="gameID" value="<%=request.getParameter("gameID") %>" required>
							</div>
						</div>
						
						<button class="w3-btn w3-block w3-green w3-section w3-padding" type="submit"  >Confirm Payment of &#8377;50</button>
