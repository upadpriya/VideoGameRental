    ...
    <div style="margin:0 -16px">     
        ...
        <%
        	System.out.println("Inside user.jsp");
				...
				String query = "SELECT rentid, DORent, game_name, developer, i.gameid FROM rent r join inventory i on r.gameid = i.gameid WHERE DOReturn is null and uid  = (SELECT uid FROM user where username = '"+uname+"' )  ";
